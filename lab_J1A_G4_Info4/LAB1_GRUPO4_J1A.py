...
# Title: LAB1_GRUPO4_J1A
# Author: Adriana La Rotta- Jose Yanez
...
class LAB1_GRUPO4_J1A(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "LAB1_GRUPO4_J1A")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("LAB1_GRUPO4_J1A")
        ...
        self.settings = Qt.QSettings("GNU Radio", "LAB1_GRUPO4_J1A")
...
def main(top_block_cls=LAB1_GRUPO4_J1A, options=None):
