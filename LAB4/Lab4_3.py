...
class Lab4_3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "demulador FM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("demulador FM")
        ...
        # Blocks
        ##################################################
        self._fc_range = Range(88100000, 115000000, 1, 88100000, 200)
        ...
        self._Ga_range = Range(0, 100, 1, 50, 200)
        ...
        self.connect((self.analog_wfm_rcv_0, 0), (self.qtgui_freq_sink_x_1_0, 0))
