...
class practica13(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "practica13")
        ...
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 81000, 1, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 72000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_2, 0), (self.rational_resampler_xxx_1, 0))
...
def main(top_block_cls=practica13, options=None):
