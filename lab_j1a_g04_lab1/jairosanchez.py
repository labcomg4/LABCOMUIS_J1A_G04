...
class jairosanchez(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "proyecto2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("proyecto2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "jairosanchez")
...
def main(top_block_cls=jairosanchez, options=None):
